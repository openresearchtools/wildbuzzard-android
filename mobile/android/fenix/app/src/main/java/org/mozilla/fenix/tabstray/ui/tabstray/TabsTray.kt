    ...
    Scaffold(
        ...
        topBar = {
            TabsTrayBanner(
                ...
                shouldShowTabAutoCloseBanner = tabsTrayState.selectedPage == Page.NormalTabs && tabsTrayState.config.showTabAutoCloseBanner,
                shouldShowLockPbmBanner = tabsTrayState.selectedPage == Page.PrivateTabs && tabsTrayState.privateBrowsing.showLockBanner,
