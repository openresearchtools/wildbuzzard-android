    ...
    @Override public void onCreate(Bundle saved) {
        ...
        try {
            ...
            new AlertDialog.Builder(this).setTitle("Allow command-line browser control?")
                .setMessage("Key " + fingerprint + "\n\nOnly approve if this matches the command you started. Programs with this key can create and control their own tabs, read pages, and act using saved logins and imported onion credentials. They cannot control other apps' tabs. Revoke access from WildBuzzard's menu.")
