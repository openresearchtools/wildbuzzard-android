    ...
    @Override public void onCreate(Bundle state) {
        ...
        try {
            ...
            new AlertDialog.Builder(this).setTitle("Allow browser control?")
                    .setMessage(name + " can create and control its own tabs, read their pages, and act using saved logins and imported onion credentials in those tabs. You can revoke access from WildBuzzard's menu.")
