...
allowed_prefixes = (
    ...
    'mobile/android/fenix/app/src/beta/res/',
    'mobile/android/fenix/app/src/nightly/res/',
    'mobile/android/fenix/app/src/release/res/',
...
allowed_files = {
    ...
    'mobile/android/fenix/app/src/beta/ic_launcher-web.webp',
    'mobile/android/fenix/app/src/nightly/ic_launcher-playstore.png',
    'mobile/android/fenix/app/src/nightly/ic_launcher-web.webp',
    'mobile/android/fenix/app/src/release/ic_launcher-playstore.png',
    'mobile/android/fenix/app/src/release/ic_launcher-web.webp',
